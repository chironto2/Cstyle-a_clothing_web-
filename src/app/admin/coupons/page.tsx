...
export const metadata = {
  title: 'Manage Coupons - Admin - Cstyle',
...
async function fetchAdminCouponsPageData(): Promise<Coupon[]> {
  ...
  try {
    ...
    console.log(
      `[AdminCouponsPage] Successfully fetched ${coupons.length} coupons.`
    );
    // Service already converts dates to ISO strings and _id to id.
    return coupons;
  } catch (error: any) {
    console.error(
      '[AdminCouponsPage] CRITICAL: Error fetching coupons:',
      error.message
    );
    return [];
  }
  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>
          Create, view, edit, and manage discount coupons for your e-commerce
          platform.
        </CardDescription>
      </CardHeader>
      <CardContent>
