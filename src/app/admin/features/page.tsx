...
export const metadata = {
  title: 'Manage Features - Admin - Cstyle',
  description:
    'Configure various site features like the hero slider, promotions, etc.',
};
      ...
      <Card className="shadow-lg border-none">
        <CardHeader className="pb-4">
          ...
          <CardDescription className="text-md pt-1">
            Manage and configure different interactive and promotional features
