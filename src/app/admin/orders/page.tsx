...
export const metadata = {
  title: 'Manage Orders - Admin - Cstyle',
...
async function fetchAdminOrders(): Promise<Order[]> {
  ...
  try {
    ...
    console.log(
      `[AdminOrdersPage] Successfully fetched ${orders.length} orders.`
    );
    ...
    console.error(
      '[AdminOrdersPage] CRITICAL: Error fetching orders:',
      error.message
    );
    return [];
  }
  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>
          View, track, and manage all customer orders from this section.
        </CardDescription>
      </CardHeader>
      <CardContent>
