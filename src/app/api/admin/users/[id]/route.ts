...
export async function PUT(
  ...
  try {
    ...
    console.log(
      `[API /api/admin/users/[id]] Update role body for ID ${id}:`,
      body
    );
    ...
    console.log(
      `[API /api/admin/users/[id]] User role for ${id} updated successfully.`
    );
...
export async function DELETE(
  ...
  try {
    ...
    console.error(
      `[API /api/admin/users/[id]] DELETE Error for ID ${id}:`,
      error
    );
    return NextResponse.json(
