...
export const metadata = {
  title: 'Payment Methods - Cstyle',
  description: 'View your payment options for Cstyle.',
};
  ...
  return (
    <Card className="shadow-lg">
      <CardHeader>
        ...
        <CardDescription>
          Information about how you can pay for your orders on Cstyle.
        </CardDescription>
      </CardHeader>
      <CardContent className="space-y-6">
        <div>
          ...
          <p className="text-muted-foreground">
            ...
            for all orders. You can pay in cash when your order is delivered to
            your doorstep.
          </p>
        </div>
        ...
        <div>
          ...
          <p className="text-muted-foreground">
            We are working hard to bring you more convenient payment methods
            soon, including:
          </p>
