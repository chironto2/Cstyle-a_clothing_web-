  ...
  return (
    <footer className="bg-primary text-primary-foreground mt-auto pt-10 pb-4">
      <Container className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
        ...
        <div>
          <h2 className="text-2xl font-headline font-bold mb-4">Cstyle</h2>
          <p className="text-sm text-primary-foreground/80 mb-4">
            Discover your perfect style with our curated collection of premium
            fashion items. Quality and trends delivered to your doorstep.
          </p>
          <div className="flex space-x-4">
            {socialLinks.facebook && (
              <Link
                ...
                className="text-primary-foreground/80 hover:text-accent transition-all duration-300 hover:scale-110 transform"
              >
                <Facebook size={20} />
              </Link>
            )}
      ...
      <div className="border-t border-primary-foreground/20 mt-6 pt-4 text-center">
        <p className="text-xs text-primary-foreground/70">
          &copy; {new Date().getFullYear()} Cstyle Fashion. All rights reserved.
        </p>
      </div>
    </footer>
  );
